...
class TodoForm extends Component {
    ...
    keyHandler(e) {
        if (e.key === 'Enter') {
            e.shiftKey ? this.props.handleSearch() : () => this.add(this.props.description)
        ...
        return (
            <div role = "form" className = "todoForm" >
                ...
                <Grid cols="12 3 2">
                    ...
                    <IconButton style="defult" icon="close" onClick={this.props.handleClear} />
                </Grid>
            </div>
        )
    }
...
const mapDespatchToProps = dispatch => bindActionCreators({ changeDescription, search, add }, dispatch)
